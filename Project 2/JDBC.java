...
public class JDBC {
	...
	public static void main(String[] args) throws Exception {
		...
		while(true){
			...
			System.out.println("Enter table name or query for sampling:");
			System.out.println("(Queries other than select are supported)");
			...
			// How many sample rows are desired, do the sampling
