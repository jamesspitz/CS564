...
//NEW PORTION
#ifdef DEBUG //check for erros
  std::cout<< "check for bugs at "<<__LINE__  <<std::endl;
#endif
//END PORTIOM
...
//NEW PORTION
#ifdef DEBUG //check for erros specifically numbers
  std::cout<< "mismatched page number "<<__LINE__  <<std::endl;
#endif
//END PORTIOM
...
//NEW PORTION
#ifdef DEBUG //check for erros
  std::cout<< "unused slot found "<<__LINE__  <<std::endl;
#endif
//END PORTIOM
    throw InvalidRecordException(record_id, page_number());
  }
